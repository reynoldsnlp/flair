...
public class ConstructionSliderBundleRussian extends LanguageSpecificConstructionSliderBundle {
    ...
    @UiField
    @LocalizedField
    GrammaticalConstructionPanelItem            pnl1stConjugationClassesUI;
    @UiField
    @LocalizedField
    GrammaticalConstructionPanelItem            pnl2ndConjugationClassesUI;
    @UiField
    @LocalizedField
    GrammaticalConstructionPanelItem pnlNegationUI;
    @UiField
    @LocalizedField
    GrammaticalConstructionPanelItem pnlDeterminersUI;
    @UiField
    @LocalizedField
